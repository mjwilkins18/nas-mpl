...
val comp_init = _import "compute_initial_conditions" public: real array * real array * int * int * int -> int;


val NTOTAL = NX * NY * NZ
val EXPMAX = (NITER_DEFAULT*(NX* NX div 4 + NY * NY div 4 + NZ * NZ div 4))

(* Globally accessed arrays *)
val d = #[NX, NY, NZ]
val EX : real array = Array.array(EXPMAX+1, 0.0)
val SUMS : dcomplex array = Array.array(NITER_DEFAULT+1, (0.0, 0.0))
val U : dcomplex array = Array.array(NX, (0.0, 0.0))


val init_conditions_file = "inputs/ft_" ^ CLASS ^ "_input.txt"
